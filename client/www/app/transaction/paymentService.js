(function(){
  ...
  //Implementation
    ...
    function getAccountBalance(user_id){
      return $http({
        method: 'GET',
        url: 'https://evening-woodland-7839.herokuapp.com/api/payments/' + user_id + '/balance',
    ...
    function charge(transaction){
      return $http({
        method: 'POST',
        url: 'https://evening-woodland-7839.herokuapp.com/api/payments/charges',
        data: transaction,
        headers: {
          'Content-Type': 'application/json',
        }
    ...
    function withdrawal(transaction){
      return $http({
        method: 'POST',
        url: 'https://evening-woodland-7839.herokuapp.com/api/payments/withdrawals',
        data: transaction,
        headers: {
          'Content-Type': 'application/json',
        }
